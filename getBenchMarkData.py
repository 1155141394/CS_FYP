...
os.system('tsbs_generate_data --use-case="iot" --seed=123 --scale=800 '
...
for i in range(4):
    ...
    file_name_1 = "benchmark_diagnostics_" + str(beg_date) + ".csv"
    file_name_2 = "benchmark_readings_" + str(beg_date) + ".csv"
