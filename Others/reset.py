...
#
# os.system('tsbs_generate_data --use-case="devops" --seed=123 --scale=5 '
#           '--timestamp-start="2022-4-01T00:00:00Z"'
...
cur = conn.cursor()
# today = date.today()
beg_date = datetime.strptime("2023-04-09 00:00:00", '%Y-%m-%d %H:%M:%S')
for i in range(5):
    beg_time = time.time()
